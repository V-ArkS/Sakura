...
#Speed setting functions
    ...
    def linePatrol():
        ...
        # edge_detect
        blur_im = Vehicle.edge_detect(frame, 254, 255, 20, 15)
        # positioning
        position = Vehicle.positioning(blur_im, 0, 0.7, 0.8)
        # steering
        leftSpeed, rightSpeed = Vehicle.steering(position, 0, 4, 2, 2)
    ...
    def colourPatrol():
        ...
        if flag == -1:
            ...
            if 5 <= abs(position - WIDTH / 2):
                ...
                leftSpeed = (position / WIDTH) * 0.5
                rightSpeed = (1 - position / WIDTH) * 0.5
