...
# TIME_STEP = 64
    ...
    @staticmethod
    def Edge_detect_based(type_select_frame=0, color_flag=-1,threshold=254, maxVal=255, kernel_1=20, kernel_2=15,
                          type_select_position=0, height_per_1=0.7, height_per_2=0.8, rectify_pixel=0, base_speed=0,
                          straight_speed=0):
        # initialization
        Sakura.camera_initiate()
        # get_frame
        Sakura.get_frame(type_select_frame, color_flag)
        # edge_detect
        Sakura.edge_detect(threshold, maxVal, kernel_1, kernel_2)
        # positioning
        Sakura.positioning(type_select_position, height_per_1, height_per_2)
        # steering
        Sakura.steering(type_select_position, rectify_pixel, base_speed, straight_speed)

    # linePatrol
    # Edge_detect_based(0, -1, 254, 255, 20, 15, 0, 0.7, 0.8, 0, 5, 0, 0)
    # bridgeFound
    # Edge_detect_based(0, -1, 180, 255, 20, 15, 0, 0.3, 0.6, 0, 5, 5.0, 3.0)
    # archFound
    # Edge_detect_based(0, -1, 100, 255, 20, 15, 0, 0.3, 0.8, 0, 5, 5.0, 2.0)
